                    ...
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
                        ...
                        <Section>
                            {alerts.map((alert, index) => (
                                <Row key={index} className="border-b border-solid border-[#eaeaea] py-[12px]">
                                    <Column width="20" align="left" className="align-middle">
                                        <div className={`w-2 h-2 rounded-full mr-2 ${alert.status === 'down' ? 'bg-[#e11d48]' : 'bg-[#d97706]'}`} />
                                    </Column>
                                    <Column align="left">
                        ...
                        <Section className="mt-[32px]">
                            <Link href="https://sentinel.com/dashboard" className="text-blue-600 text-[14px] no-underline">
                        ...
                        <Text className="text-[#666666] text-[12px] leading-[24px]">
                            You are receiving this email because you are subscribed to component alerts on Sentinel.
                        </Text>
                    </Container>
                </Body>
            </Tailwind>
